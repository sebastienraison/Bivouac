...
Disponible en anglais (par défaut) et en français, selon la langue de l'appareil (ou la langue
par application sur Android 13+). Pas de sélecteur de langue dans l'app. Nombres, dates et
durées suivent la locale du système.
