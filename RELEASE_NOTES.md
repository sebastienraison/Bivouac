...
- The interface is now available in English (default) and French, following the device's
  language (or the per-app language setting on Android 13+); no in-app language switch
- Numbers, dates and durations are displayed according to the system locale
