...
# Corrections ponctuelles de deux lignes de l'inventaire, releves en construisant ce generateur
# (RIC-187) et a corriger a la source dans une prochaine passe de l'inventaire :
#
...
#   toutes lettres plutot que de tenter de la parser depuis la prose.
